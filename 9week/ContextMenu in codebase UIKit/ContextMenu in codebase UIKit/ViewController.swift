...
class ViewController: UIViewController, UIContextMenuInteractionDelegate {
    ...
    func contextMenuInteraction(_ interaction: UIContextMenuInteraction, configurationForMenuAtLocation location: CGPoint) -> UIContextMenuConfiguration? {
        return UIContextMenuConfiguration(identifier: nil, previewProvider: nil) { _ in
            ...
            let prupleAction = UIAction(title: "보라", image: nil) { _ in
            ...
            let colorMenu = UIMenu(title: "색상", options: .displayInline, children: [redAction, prupleAction])
